 ...
 */
class Activerules_Objectcache extends Activerules_Storage
{
    ...
    public function write($container, $filename, $data, $cache=FALSE)
    {
		...
		catch (ErrorException $e)
		{
			...
			if ($e->getCode() === E_NOTICE)
			{
				...
				throw new Activerules_Objectcache_Exception(__METHOD__.' failed to serialize data for storage with message : '.$e->getMessage());
			}
