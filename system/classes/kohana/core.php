...
class Kohana_Core {
	...
	public static function init(array $settings = NULL)
	{
		...
		else
		{
            ...
            // ACtiveRules use CACHEPATH
			Kohana::$cache_dir = CACHEPATH.'cache';
		}
	...
	public static function deinit()
	{
		if (Kohana::$_init)
		{
            ...
            // ActiveRules removed APPPATH from array
			Kohana::$_paths   = array(SYSPATH);
	...
	public static function modules(array $modules = NULL)
	{
        ...
        // ACtiveRules removed APPPATH as first element
		$paths = array();
