 ...
 */
class Controller_Activerules_Splitleft extends Controller_Activerules
{
     /**
	...
	{
        Page::instance()->set_page_data('layout_template', 'layout/contentleft');

        Page::instance()->set_page_data('layout_css', 'activerules.css');

        Page::instance()->set_page_data('css_override', 'html/split_view_css_override');
