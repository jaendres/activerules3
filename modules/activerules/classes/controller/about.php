 ...
 */
class Controller_About extends Controller_Activerules_Standard
{
	...
	public function action_index()
	{
        ...
        Page::instance()->set_extra_data('selected_nav', 'about');

        Page::instance()->set_extra_data('localization_file', 'about');
	}
